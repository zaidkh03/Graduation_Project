...
$query = $conn->query("
  ...
  FROM parents
  JOIN students ON students.parent_id = parents.id

  -- Get latest academic record per student
  JOIN (
    SELECT *
                ...
                <h6 style="opacity: 0.5;">Mentor Teacher Info</h6>
                  ...
                  <table class="mx-auto">
                    <tr>
                      <td><i class="fas fa-phone"></i></td>
                      <td>
                        <?php if (!empty($info['teacher_phone'])): ?>
                          <a href="tel:<?= htmlspecialchars($info['teacher_phone']) ?>"><?= htmlspecialchars($info['teacher_phone']) ?></a>
                        <?php else: ?>
                          <span>N/A</span>
                        <?php endif; ?>
                      </td>
                    ...
                    <tr>
                      <td><i class="fas fa-envelope"></i></td>
                      <td>
                        <?php if (!empty($info['teacher_email'])): ?>
                          <a href="mailto:<?= htmlspecialchars($info['teacher_email']) ?>"><?= htmlspecialchars($info['teacher_email']) ?></a>
                        <?php else: ?>
                          <span>N/A</span>
                        <?php endif; ?>
                      </td>
