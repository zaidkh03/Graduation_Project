...
.select2-container--bootstrap5 .select2-selection--single {
  ...
  position: relative;
  padding-right: 2.75rem; /* Space for arrow + clear */
}
...
.select2-container--bootstrap5 .select2-selection__clear {
  float: right;
  margin-right: 0.1rem; /* move away from arrow */
  margin-top: 0.3rem;
  font-size: 2rem; /* increase click size */
  color: #dc3545;
  cursor: pointer;
}
...
.select2-container--bootstrap5 .select2-selection__arrow::after {
  ...
  border-top: 6px solid #6c757d; /* Bootstrap secondary */
