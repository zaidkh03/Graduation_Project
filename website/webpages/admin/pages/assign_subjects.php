...
$gradingStarted = !empty($class['grading_status_json']) && $class['grading_status_json'] !== '{}' && $class['grading_status_json'] !== 'null';
...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <?php if (!$gradingStarted): ?>
              <form method="POST" onsubmit="return confirm('Are you sure you want to delete all subject assignments for this class?');">
                <input type="hidden" name="delete_all" value="1">
                <button type="submit" class="btn btn-danger">Delete All Subjects</button>
              </form>
            <?php else: ?>
              <button class="btn btn-danger" disabled style="opacity: 0.6; cursor: not-allowed;">Delete All Subjects</button>
            <?php endif; ?>
          </div>
        </div>
      </section>
      ...
      <section class="content">
        <div class="container-fluid">
          <form method="POST">
            ...
            <button type="button" class="btn btn-secondary mb-3" id="addMore" <?= $gradingStarted ? 'disabled style="opacity: 0.6; cursor: not-allowed;"' : '' ?>>+ Add Subject</button>
  ...
  <script>
    ...
    const gradingStarted = <?= $gradingStarted ? 'true' : 'false' ?>;
    ...
    function renderRow(preSubjectId = "", preTeacherId = "") {
      ...
      if (gradingStarted) {
        subjectSelect.classList.add('readonly-select');
        subjectSelect.style.pointerEvents = 'none';
        subjectSelect.style.backgroundColor = '#e9ecef';
      ...
      if (gradingStarted) {
        ...
        removeBtn.title = "Disabled because grading has started.";
      } else {
        removeBtn.onclick = () => {
