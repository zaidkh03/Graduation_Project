        ...
        <form id="reassignForm">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-danger" id="confirmReassignBtn">
...
$(document).ready(function () {
  $('#reassignForm').on('submit', function (e) {
    ...
    const newMainAdminId = $('#new_main_admin_id').val();
    ...
    if (!confirm('Are you sure you want to make this the new main admin?')) {
      return;
    }

    $.ajax({
      url: 'reassign_main_admin.php',
      type: 'POST',
      data: { new_main_admin_id: newMainAdminId },
