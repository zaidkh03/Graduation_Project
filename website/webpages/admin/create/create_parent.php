...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (empty($errors)) {
    ...
    if ($stmt->execute()) {
      ...
      $errors['general'] = "Error inserting into parents table: " . $stmt->error;
    }
  }
}
?>
    ...
    <div class="content-wrapper" style="margin-top: 50px;">
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6"><h1>Create Parent</h1></div>
          </div>
        </div>
      </section>
        ...
        <div class="container-fluid">
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header"><h3 class="card-title">Create a Parent</h3></div>
