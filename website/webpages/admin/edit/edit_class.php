...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE class SET grade=$grade, section='$section', capacity=$capacity, mentor_teacher_id=$mentor_teacher_id WHERE id=$id";
              ...
              <div class="card-body p-0">
                <form method="POST">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="Grade" name="grade" value="<?= $class['grade'] ?>" required />
                  </div>

                  <div class="form-group">
                    <label for="Section">Section</label>
                    <input type="text" class="form-control" id="Section" name="section" value="<?= htmlspecialchars($class['section']) ?>" required />
                  </div>
