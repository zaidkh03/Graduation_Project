...
// Define student ID (replace with session variable if available)
$studentId = 1;

$sql = "SELECT marks_json FROM academic_record WHERE student_id = $studentId";
...
if ($result && $row = $result->fetch_assoc()) {
    ...
    if ($marksJson && is_array($marksJson)) {
        $marks = $marksJson;
    }
}
?>
